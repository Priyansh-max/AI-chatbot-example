    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-105 transition-all duration-300 flex items-center justify-center group"
        >
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] h-[580px] rounded-2xl bg-[#111113] border border-white/10 shadow-2xl shadow-black/50 flex flex-col overflow-hidden animate-slideIn">
          {/* Header */}
          <div className="flex items-center justify-between px-5 py-4 border-b border-white/5 bg-[#0a0a0b]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-['Syne'] font-semibold text-white text-sm">Spur Support</h3>
                <p className="text-[11px] text-zinc-500">We typically reply instantly</p>
              </div>
            </div>
            <button
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-2">
              {conversations.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center px-6">
                  ...
                  <p className="text-sm text-zinc-400">No past conversations</p>
                  <p className="text-xs text-zinc-600 mt-1">Start a chat to see history here</p>
                </div>
              ) : (
